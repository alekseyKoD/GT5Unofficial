...
public class GT_MetaTileEntity_HugeTurbine_Gas extends GT_MetaTileEntity_HugeTurbine {

    public GT_MetaTileEntity_HugeTurbine_Gas(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public GT_MetaTileEntity_HugeTurbine_Gas(String aName) {
        super(aName);
    }
    ...
    public String[] getDescription() {
        return new String[]{
                "Controller Block for the Huge Gas Turbine",
                ...
                "Needs 5 same type Turbine Items (Inside controller GUI)",
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_HugeTurbine_Gas(mName);
    }
