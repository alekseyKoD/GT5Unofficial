...
public class GT_MetaTileEntity_HugeTurbine_Steam extends GT_MetaTileEntity_HugeTurbine {

    private float water;
    private boolean achievement = false;

    public GT_MetaTileEntity_HugeTurbine_Steam(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }


    public GT_MetaTileEntity_HugeTurbine_Steam(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_HugeTurbine_Steam(mName);
    }
