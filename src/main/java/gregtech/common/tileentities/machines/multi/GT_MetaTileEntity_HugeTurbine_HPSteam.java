...
public class GT_MetaTileEntity_HugeTurbine_HPSteam extends GT_MetaTileEntity_HugeTurbine {

    public boolean achievement = false;

    public GT_MetaTileEntity_HugeTurbine_HPSteam(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public GT_MetaTileEntity_HugeTurbine_HPSteam(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_HugeTurbine_HPSteam(mName);
    }
