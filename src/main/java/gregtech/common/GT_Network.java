...
public class GT_Network
    ...
    public GT_Network() {
        ...
        this.mSubChannels = new GT_Packet[]{new GT_Packet_TileEntity(), new GT_Packet_Sound(), new GT_Packet_Block_Event(), new GT_Packet_Ores(), new GT_Packet_Pollution(), new MessageSetFlaskCapacity(), new GT_Packet_ExtendedBlockEvent(), new GT_Packet_OpenResearch(), new GT_Packet_CompletedResearches(), new GT_Packet_StartResearch(), new GT_Packet_SaveInformation(), new GT_Packet_ResearchProgress()};
    }
